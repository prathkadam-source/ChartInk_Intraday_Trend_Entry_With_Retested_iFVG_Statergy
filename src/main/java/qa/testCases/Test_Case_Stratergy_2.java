...
public class Test_Case_Stratergy_2 extends BaseTest {
    ...
    public void Sell_Trades() throws InterruptedException {

        ReportUtil.report( true, "INFO", "-- Test case 2 -- Starting -- Sell_Trades",  "");
        ...
        try {
            ...
            ReportUtil.report( false, "FAIL", "Test case 2 Sell_Trades, ",  e.getMessage());
        }

        ReportUtil.report( true, "INFO", "-- Test case 2 -- Ending -- Sell_Trades\"",  "");
